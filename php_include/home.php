...
<span class=""><a class="hitbtnmain hitbtn<?=$Tstatusid?>" id="<?=$Tstatusid?>">Hit</a></span><span class="on-right dotseparator">∙</span>
...
<div class="carousel" data-role="carousel" data-effect="fade" data-period="5000" data-markers-position="bottom-right">
<?php
...
<span class="fg-darkBlue commentername">Vivek Kumar </span><span class="commenttxt">This is test CommentIf the weapon is your love, I got my hands up. If you're gonna take me down, I surrender. This is only for me and photo in private So none will be able to view it!!!!!</span>
<div class="commenttimeaction"><span class="commenttime">17 Aug 2014 23:30</span><span class="on-right dotseparator">∙</span><span class="commentactionbox">
<span class=""><a class="hitbtnmain .hitbtn<?=$Tstatusid?>" id="<?=$Tstatusid?></a></span><span class="on-right dotseparator">∙</span>
...
} // while() for all story ends
} //if atleast 1 story found check ends
?>




</div> <!-- feedcontainer ends -->

<div class="newsfeedloader span10 text-center"><a class="span5 loadmorefeed btn">Load More Feeds</a>
<span class="LoadSpinner newsfeedloadspinner" style="display:none"></span>
</div>

<div class="span4 adcontainer">
<!-- ADDS -->
</div>
</div>